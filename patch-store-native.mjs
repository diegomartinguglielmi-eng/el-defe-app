...
// Si algún build antiguo había delegado el click a un interceptor, devolver control al checkout nativo.
...
js+='\n/* DEFE_STORE_NATIVE_EXACT_V6 */\n/* DEFE_STORE_NATIVE_RAILWAY_V1 */\n';
fs.writeFileSync(jsPath,js);
console.log('Checkout nativo V6: carrito React + catálogo Railway vivo + validación de talle.');
