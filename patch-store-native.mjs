...
js+='\n/* DEFE_STORE_NATIVE_EXACT_V5 */\n/* DEFE_STORE_NATIVE_RAILWAY_V1 */\n';
fs.writeFileSync(jsPath,js);
console.log('Checkout nativo V5: payload tolerante + ID/slug/nombre + reset al volver de WhatsApp.');
