(() => {
 ...
 async function loadAdminData(){if(document.documentElement.dataset.defeRole!=='admin'||adminLoading)return;adminLoading=true;try{adminData=await core.api('/api/availability/v2/admin');renderAdminHome()}catch(_){ }finally{adminLoading=false}}
 ...
 function renderAdminHome(){
   if(document.documentElement.dataset.defeRole!=='admin'||document.getElementById('defe-mi-defe')||!adminData)return;
