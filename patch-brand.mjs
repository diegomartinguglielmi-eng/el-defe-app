...
const logoFn='function Ns({size:e=34}){return u.jsx("img",{src:"/el-defe-app/escudo-dsl.svg?v=4",alt:"Escudo Defensores de Santos Lugares",style:{width:e,height:e*1.15,objectFit:"contain",display:"block",filter:"drop-shadow(0 3px 6px rgba(0,0,0,.30))"}})}';
...
const newHeader='u.jsxs("div",{className:x==="midefe"?"defe-hero defe-hero-profile":"defe-topbar",style:{color:"#fff",position:x==="midefe"?"relative":"sticky",top:0,zIndex:40},children:[u.jsxs("div",{className:x==="midefe"?"defe-hero-inner":"flex items-center gap-3 px-4 pb-3 pt-4",children:[u.jsx(Ns,{size:x==="midefe"?86:38}),u.jsxs("div",{className:"flex-1",children:[u.jsx("div",{className:x==="midefe"?"defe-hero-title":"defe-topbar-title",children:x==="midefe"?"MI DEFE":yn[x].toUpperCase()}),u.jsx("div",{className:x==="midefe"?"defe-hero-sub":"defe-topbar-sub",children:"DEFENSORES DE SANTOS LUGARES"}),x==="midefe"&&u.jsx("div",{className:"defe-hero-tag",children:"EL GIGANTE DE TRES DE FEBRERO"})]}),x!=="midefe"&&u.jsxs("button",{onClick:()=>_("midefe"),className:"flex items-center gap-1.5 rounded-full px-3 py-1.5",style:{background:["midefe","gestion"].includes(x)?"rgba(255,255,255,.25)":"rgba(255,255,255,.14)"},"aria-label":"Mi Defe",children:[u.jsx(iw,{size:15}),u.jsx("span",{className:"text-xs font-semibold",children:e?"Mi Defe":"Ingresar"})]})]}),x==="midefe"&&u.jsxs("div",{className:"defe-hero-side",children:[u.jsx("span",{children:"BARRIO"}),u.jsx("span",{children:"FAMILIA"}),u.jsx("span",{children:"FUTSAL"}),u.jsx("span",{children:"PASIÓN"}),u.jsx("span",{children:"SIEMPRE"})]}),x==="midefe"&&u.jsx("div",{className:"defe-hero-year",children:"1922"}),o&&u.jsx("div",{className:"px-4 pb-2 text-xs",style:{opacity:.8},children:"Sin conexión: estás viendo lo último que se descargó."})]})';
...
js+='\n/* DEFE_BRAND_V4_20260909 MI_DEFE_EDITORIAL */\n';
...
html=html.replace(/<meta name="defe-brand" content="[^"]*"\s*\/>/,'<meta name="defe-brand" content="v4-20260909" />');
if(!html.includes('defe-brand')) html=html.replace('</head>','<meta name="defe-brand" content="v4-20260909" /></head>');
...
if(fs.existsSync(manifestPath)){
 ...
 manifest.icons=[{src:'/el-defe-app/escudo-dsl.svg?v=4',sizes:'any',type:'image/svg+xml',purpose:'any maskable'}];
